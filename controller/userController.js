...
const userCart = asyncHandler(async (req, res) => {
  ...
  // price = Number(price)
  // console.log('params==',productId, quantity, price);
  // const { _id } = req.user;
  // console.log("reqbody-----------", req.body);
  // validateMongoDbId(_id);
  //   try {
  //     // Check if a cart item already exists for the user
  //     let existingCart = await Cart.findOne({ userId: _id, productId });

  //     if (existingCart) {
  //       // If cart item exists, update the quantity
  //       console.log(existingCart.quantity)
  //       existingCart.quantity += quantity;
  //       existingCart.price += price; // Optionally update the price
  ...
  //     // Fetch updated cart items and populate the product details
